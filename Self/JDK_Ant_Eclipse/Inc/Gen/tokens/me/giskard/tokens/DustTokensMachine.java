...
public interface DustTokensMachine extends GiskardConsts {
	...
	MiNDToken MTMEMBER_MACHINE_CURRENTAPP = Giskard.defineToken(MiNDTokenType.MEMBER, "CurrentApp", MTTYPE_MACHINE, MiNDValType.Link, MiNDCollType.One);
	
	MiNDToken MTTYPE_APPLICATION = Giskard.defineToken(MiNDTokenType.TYPE, "Application", MTUNIT_MACHINE);
	MiNDToken MTMEMBER_APPLICATION_MODULES = Giskard.defineToken(MiNDTokenType.MEMBER, "Modules", MTTYPE_APPLICATION, MiNDValType.Link, MiNDCollType.Set);
	MiNDToken MTMEMBER_APPLICATION_MAINAGENT = Giskard.defineToken(MiNDTokenType.MEMBER, "MainAgent", MTTYPE_APPLICATION, MiNDValType.Link, MiNDCollType.One);
