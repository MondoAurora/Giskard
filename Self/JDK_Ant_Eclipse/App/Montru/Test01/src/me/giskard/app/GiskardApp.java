...
DustTokensGuard, DustTokensDB, DustTokensText, DustTokensGeometry, DustTokensGui {
	...
	public static final MiNDResultType boot(String[] args) throws Exception {
		...
		Giskard.access(MiNDAccessCommand.Get, MTMEMBER_ACTION_TARGET);
...
//		testDB();
	...
	public static void testGui() throws Exception {
		...
		Giskard.access(MiNDAccessCommand.Get, MTMEMBER_ACTION_TARGET, MTSHARED_MACHINE, MTMEMBER_GUIOWNER_WORLD, MTMEMBER_WORLD_RENDERER);
		Giskard.access(MiNDAccessCommand.Get, MTMEMBER_ACTION_PARAM, MTMEMBER_ACTION_THIS);
	}

	public static void testDB() {
		Giskard.access(MiNDAccessCommand.Set, MTAGENT_DBTEST01, MTMEMBER_ACTION_TARGET, MTMEMBER_ENTITY_PRIMARYTYPE);
		
		Giskard.access(MiNDAccessCommand.Set, "com.mysql.cj.jdbc.Driver", MTMEMBER_ACTION_TARGET, MTMEMBER_DRIVER);
