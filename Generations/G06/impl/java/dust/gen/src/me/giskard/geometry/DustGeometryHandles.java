...
public interface DustGeometryHandles extends DustConsts {
	...
	MindHandle GEOMETRY_TAG_VECTOR_LOCATION = Dust.access(MindAccess.Lookup, "giskard.me:geometry_1.0:5");

	MindHandle GEOMETRY_TAG_VECTOR_SIZE = Dust.access(MindAccess.Lookup, "giskard.me:geometry_1.0:6");

	MindHandle GEOMETRY_TAG_VECTOR_WEIGHT = Dust.access(MindAccess.Lookup, "giskard.me:geometry_1.0:7");

	MindHandle GEOMETRY_TAG_VECTOR_SCALE = Dust.access(MindAccess.Lookup, "giskard.me:geometry_1.0:8");

	MindHandle GEOMETRY_TAG_VECTOR_ROTATE = Dust.access(MindAccess.Lookup, "giskard.me:geometry_1.0:9");
