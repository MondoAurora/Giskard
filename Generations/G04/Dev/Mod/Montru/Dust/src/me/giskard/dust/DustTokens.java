...
//	MiNDHandle DUST_SRC_ROOT = Giskard.access(MiNDAccessCommand.Get, null);
	...
	MiNDHandle MODEL_MEM_SOURCE_HANDLES = Giskard.access(MiNDAccessCommand.Get, null);
	...
	MiNDHandle NARRATIVE_MEM_JOURNEY_ENTITIES = Giskard.access(MiNDAccessCommand.Get, null);
	...
	MiNDHandle LANG_MEM_TERM_STRING = Giskard.access(MiNDAccessCommand.Get, null);
