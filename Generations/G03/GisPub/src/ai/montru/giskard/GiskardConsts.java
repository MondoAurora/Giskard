...
public interface GiskardConsts {
	...
	interface GiskardNativeLogic {
		GiskardResponse gisExecLogic() throws GiskardException;
	}

	public interface GiskardModule {
		Iterable<GiskardEntityRef> gisInitModule(Giskard runtime, String name, String version) throws Exception;
	}
