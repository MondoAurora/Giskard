...
import ai.montru.giskard.GiskardConsts.GiskardNativeLogic;
import ai.montru.utils.MontruUtils;

public abstract class DustNodeAgentCtrl implements DustNodeConsts, GiskardNativeLogic {
	...
	public static class DustVisitor extends DustNodeAgentCtrl {
		...
		public GiskardResponse gisExecLogic() throws GiskardException {
			GiskardAction action = Giskard.access(GiskardAccess.Peek, GiskardAction.class, null, GIS_ATT_DUST_THISINSTANCE, GIS_ATT_UTIL_TARGET);
