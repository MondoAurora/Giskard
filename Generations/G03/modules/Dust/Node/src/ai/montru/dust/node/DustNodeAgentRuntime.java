...
public class DustNodeAgentRuntime extends MontruMain
		implements DustNodeConsts, DustNodeConsts.GiskardNativeLogic, GisDustNode.BootModule {
	...
	public Object resolve(GiskardEntityRef ref, GiskardEntityRef type, boolean forceLocal) {
		return getEntity((DustNodeEntityRef) ref, type, (null != ref.getUnit()) && forceLocal);
	}
	...
	Map<Object, Object> getEntity(DustNodeEntityRef ref, GiskardEntityRef type, boolean forceLocal) {
		...
		DustNodeEntityRef uRef = ref.getUnit();
	...
	@Override
	protected void addInitTask(GiskardEntityRef rProc) {
	...
	public GiskardResponse gisExecLogic() throws GiskardException {
		GiskardAction action = GiskardAction.Begin;
